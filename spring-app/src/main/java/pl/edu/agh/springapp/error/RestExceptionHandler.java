...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handles WrongFieldException. Created to encapsulate errors with more detail than javax.persistence.WrongFieldException.
     *
     * @param ex the WrongFieldException
     * @return the ApiError object
     */
    @ExceptionHandler(WrongFieldsException.class)
    protected ResponseEntity<Object> handleEntityNotFound(
            WrongFieldsException ex) {
